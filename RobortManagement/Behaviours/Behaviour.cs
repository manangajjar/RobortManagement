...
namespace RobortManagement.Behaviours
{
    /// <summary>
    ...
    {
        public IRobot ToyRobot { get; private set; }
        public IToyBoardTable SquareBoard { get; private set; }
        public IInputParser InputParser { get; private set; }

        public Behaviour(IRobot toyRobot, IToyBoardTable squareBoard, IInputParser inputParser)
        {
            ToyRobot = toyRobot;
